...
final class NetworkService {
    ...
    func fetchProfile(userName: String, completion: @escaping (Result<GithubProfile, Error>) -> Void) {
        ...
        let urlString = "https://api.github.com/users/\(userName)" // 성공케이스
//        let urlString = "https://api.github.com/users1/\(userName)" // 실패케이스
...
networkService.fetchProfile(userName: "woojinchoi17") { result in
    switch result {
