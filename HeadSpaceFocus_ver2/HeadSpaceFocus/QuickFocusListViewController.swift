...
class QuickFocusListViewController: UIViewController {
    ...
    private func layout() -> UICollectionViewCompositionalLayout {
        ...
        let gorupSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(1), heightDimension: .estimated(50))
        let group = NSCollectionLayoutGroup.horizontal(layoutSize: gorupSize, subitem: item, count: 2)
